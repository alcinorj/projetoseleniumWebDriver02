...
public class RealizarAutenticacaoTest {
	...
	public void sistema_autentica_o_usuário_com_sucesso() {
		...
		//CRITÉRIO: Verificar se o usuario esta na pagina de acesso restrito		
		//obter a URL da pagina para o qual o usuario foi redirecionado..
	...
	public void sistema_exibe_a_mensagem(String mensagem) {
		...
		//CRITÉRIO: Verificar se o sistema exibe a mensagem 'Usuário ou Senha Inválido.'
		...
		//verificando se o resultado obtido é igual a mensagem definida na feature
	...
	public void sistema_informa_que_email_e_senha_são_campos_obrigatórios() {
		...
		//comparando se cada mensagem é igual a: 'Este é um campo obrigatório.'
